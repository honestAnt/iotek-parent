/*
 ...
 IBM Corporation - initial API and implementation
*/
var requirejs, require, define; (function(l) {
    function p(a, g) {
        var u, c, s, d, b, i, f, m, n, h = g && g.split("/"),
        e = j.map,
        k = e && e["*"] || {};
        if (a && a.charAt(0) === ".") if (g) {
            h = h.slice(0, h.length - 1);
            a = h.concat(a.split("/"));
            for (m = 0; m < a.length; m += 1) if (u = a[m], u === ".") a.splice(m, 1),
            m -= 1;
            else if (u === "..") if (m === 1 && (a[2] === ".." || a[0] === "..")) break;
            else m > 0 && (a.splice(m - 1, 2), m -= 2);
            a = a.join("/")
        } else a.indexOf("./") === 0 && (a = a.substring(2));
        if ((h || k) && e) {
            u = a.split("/");
            for (m = u.length; m > 0; m -= 1) {
                c = u.slice(0, m).join("/");
                if (h) for (n = h.length; n > 0; n -= 1) if (s = e[h.slice(0, n).join("/")]) if (s = s[c]) {
                    d = s;
                    b = m;
                    break
                }
                if (d) break; ! i && k && k[c] && (i = k[c], f = m)
            } ! d && i && (d = i, b = f);
            d && (u.splice(0, b, d), a = u.join("/"))
        }
        return a
    }
    function o(c, g) {
        return function() {
            return a.apply(l, t.call(arguments, 0).concat([c, g]))
        }
    }
    function e(a) {
        return function(g) {
    ...
    function d(a) {
        ...
        if (!r.call(m, a) && !r.call(q, a)) throw Error("No " + a);
        return m[a]
    }
    function h(a) {
        var g, u = a ? a.indexOf("!") : -1;
        u > -1 && (g = a.substring(0, u), a = a.substring(u + 1, a.length));
        return [g, a]
    }
    function k(a) {
        return function() {
            return j && j.config && j.config[a] || {}
        }
    }
    var f, a, c, i, m = {},
    n = {},
    ...
    c = function(a, g) {
        ...
        a = c[1];
        s && (s = p(s, g), u = d(s));
        s ? a = u && u.normalize ? u.normalize(a, e(g)) : p(a, g) : (a = p(a, g), c = h(a), s = c[0], a = c[1], s && (u = d(s)));
        return {
            f: s ? s + "!" + a: a,
            n: a,
            pr: s,
    ...
    i = {
        ...
        exports: function(a) {
            var g = m[a];
            return typeof g !== "undefined" ? g: m[a] = {}
        },
        module: function(a) {
            return {
                id: a,
    ...
    f = function(a, g, u, x) {
        ...
        if (typeof u === "function") {
            g = !g.length && u.length ? ["require", "exports", "module"] : g;
            for (j = 0; j < g.length; j += 1) if (h = c(g[j], x), f = h.f, f === "require") e[j] = i.require(a);
            else if (f === "exports") e[j] = i.exports(a),
            k = !0;
            else if (f === "module") s = e[j] = i.module(a);
            else if (r.call(m, f) || r.call(n, f) || r.call(q, f)) e[j] = d(f);
            else if (h.p) h.p.load(h.n, o(x, !0), b(f), {}),
            e[j] = m[f];
            else throw Error(a + " missing " + f);
            g = u.apply(m[a], e);
            if (a) if (s && s.exports !== l && s.exports !== m[a]) m[a] = s.exports;
            else if (g !== l || !k) m[a] = g
        } else a && (m[a] = u)
    };
    requirejs = require = a = function(b, g, u, x, s) {
        if (typeof b === "string") return i[b] ? i[b](g) : d(c(b, g).f);
        else b.splice || (j = b, g.splice ? (b = g, g = u, u = null) : b = l);
        g = g ||
        function() {};
        typeof u === "function" && (u = x, x = s);
        x ? f(l, b, g, u) : setTimeout(function() {
            f(l, b, g, u)
        },
        4);
        return a
    ...
    define = function(a, g, u) {
        g.splice || (u = g, g = []); ! r.call(m, a) && !r.call(n, a) && (n[a] = [a, g, u])
    };
    define.amd = {
        jQuery: !0
    }
    ...
    l.prototype = {
        ...
        _dispatchEvent: function(l, o) {
            ...
            if (e) {
                var b = e.listeners;
                try {
                    if (e.level++, b) for (var d = 0,
                    h = b.length; d < h; d++) if (b[d]) {
                        var k = b[d].listener;
...
function(l, p) {
    ...
    o.prototype = {
        find: function(e) {
            ...
            var b = e.string,
            d = b,
            h = e.caseInsensitive; ! e.regex && b && (d = b.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g, "\\$&"), h && (d = d.replace(/[iI\u0130\u0131]/g, "[Ii\u0130\u0131]")));
            var k = null,
            f;
            if (d) {
                var b = e.reverse,
        ...
        getLine: function(e, b) {
            ...
            if (e + 1 < d) {
                ...
                if (b) return d;
                for (var h = d.length,
                k; (k = d.charCodeAt(h - 1)) === 10 || k === 13;) h--;
        ...
        getLineAtOffset: function(e) {
            ...
            for (var a = d,
            c = -1; a - c > 1;) if (f = Math.floor((a + c) / 2), h = this._lineOffsets[f], k = f + 1 < d ? this._lineOffsets[f + 1] : b, e <= h) a = f;
            else if (e < k) {
                a = f;
                break
            } else c = f;
        ...
        getLineEnd: function(e, b) {
            ...
            if (e + 1 < d) {
                ...
                if (b) return d;
                for (var h = this.getText(Math.max(this._lineOffsets[e], d - 2), d), k = h.length, f; (f = h.charCodeAt(k - 1)) === 10 || f === 13;) k--;
                return d - (h.length - k)
    ...
    o.prototype = {
        ...
        match: function(e, b) {
            ...
            if (b !== void 0) return b > d.length ? !1 : d[b].match(e) ? b === d.length - 1 ? !0 : b + 1 : !1;
                ...
                var h;
                for (h = 0; h < e.length; h++) if (!d[h].match(e[h])) return ! 1;
        ...
        equals: function(e) {
            ...
            for (var b = 0; b < e.keys.length; b++) if (!e.keys[b].equals(this.keys[b])) return ! 1;
            return ! 0
        }
    };
    return {
...
function(l, p, o) {
    ...
    e.prototype = {
        ...
        _load: function(d, b, e) {
            if (d) if (typeof b === "string") this._createStyle(d, b, e);
...
function(l, p, o, e, b, d) {
    ...
    function k(g, a, c) {
        ...
        if (g) {
            ...
            if (c = g.style) for (var b in c) c.hasOwnProperty(b) && (a.style[b] = c[b]);
            if (g = g.attributes) for (var i in g) g.hasOwnProperty(i) && a.setAttribute(i, g[i])
        }
    }
    function f(g) {
    ...
    function c(g, a) {
        ...
        if (g instanceof Array || a instanceof Array) {
            ...
            for (var d = 0; d < g.length; d++) if (!c(g[d], a[d])) return ! 1;
            return ! 0
        }
        ...
        for (d in a) if (!g.hasOwnProperty(d)) return ! 1;
        return ! 0
    }
    function i(g, a, c) {
        for (var s = 0,
    ...
    var v = function() {
        ...
        g.prototype.stop = function() {
            this.options.window.clearInterval(this.interval); (this.options.onEnd ||
            function() {})()
        };
    ...
    r.prototype = {
        ...
        _createLine: function(g, a, b) {
            ...
            for (m = 0; m < b.length; m++) {
                ...
                s += q.length;
                j = n.style;
                if (e) if (r = e.firstChild.data, h = e.viewStyle, r === q && c(j, h)) {
                    f += r.length;
            ...
            if (a) for (g = j ? j.nextSibling: null; g;) h = g.nextSibling,
            a.removeChild(g),
            g = h;
        ...
        _createRange: function(g, a, c, s, d) {
            if (! (a > c)) {
                ...
                if (b && b !== 8) for (var i = g.indexOf("\t", a); i !== -1;) {
                    a < i && (a = {
        ...
        getClientRects: function(g) {
            ...
            for (var a = this._ensureCreated(), c = [], s = a.firstChild, d, b = a.getBoundingClientRect(); s;) {
                if (!s.ignore) for (var i = this._getClientRects(s, b), a = 0; a < i.length; a++) {
                    var f = i[a],
                    m;
                    if (f.top !== f.bottom) {
                        var n = f.top + (f.bottom - f.top) / 2;
                        for (m = 0; m < c.length; m++) if (d = c[m], d.top <= n && n < d.bottom) break;
        ...
        getLineIndex: function(g) {
            ...
            for (var a = this.getClientRects(), g = this.getBoundingClientRect(g), g = g.top + (g.bottom - g.top) / 2, c = 0; c < a.length; c++) if (a[c].top <= g && g < a[c].bottom) return c;
            return a.length - 1
        },
        ...
        getOffset: function(g, a) {
            ...
            if (c._wrapMode) {
                ...
                for (var h = 0; h < j.length; h++) if (e = j[h], e.top <= a && a < e.bottom) break;
            ...
            a: for (; l;) {
                if (!l.ignore) {
                    ...
                    for (var z = 0; z < j.length; z++) if (e = j[z], e.left <= g && g < e.right && (!c._wrapMode || e.top <= a && a < e.bottom)) {
                        if (d.isIE || c._isRangeRects) {
                            for (var k = c._isRangeRects ? k.createRange() : k.body.createTextRange(), z = m, D = -1; z - D > 1;) {
                                ...
                                j = k.getClientRects();
                                for (var J = !1,
                                G = 0; G < j.length; G++) if (e = j[G], t = e.left * q - n.left, v = e.right * q - n.left, p = e.top * r - n.top, e = e.bottom * r - n.top, t <= g && g < v && (!c._wrapMode || p <= a && a < e)) {
                                    J = !0;
                                    break
                                }
                                J ? z = E: D = E
        ...
        _getNextOffset_W3C: function(g, a) {
            ...
            j,
            e = a.count < 0 ? -1 : 1;
            if (a.unit === "word" || a.unit === "wordend" || a.unit === "wordWS" || a.unit === "wordendWS") for (var h, k, q; a.count !== 0;) {
                if (a.count > 0) {
                    if (n === i) return b;
                    j = f.charCodeAt(n);
                    h = c(j);
                ...
                a.count -= e
            } else for (; a.count !== 0 && 0 <= n + e && n + e <= i;) n += e,
            j = f.charCodeAt(n),
    ...
    t.prototype = {
        ...
        redrawRulers: function(g, a) {
            if (! (this._redrawCount > 0)) for (var c = this.getRulers(), d = 0; d < c.length; d++) this.redrawLines(g, a, c[d])
        },
        redrawLines: function(g, a, c) {
            if (! (this._redrawCount > 0) && (g === void 0 && (g = 0), a === void 0 && (a = this._model.getLineCount()), g !== a)) {
                ...
                if (d) {
                    if (c) for (d = (c.getLocation() === "left" ? this._leftDiv: this._rightDiv).firstChild; d;) {
                        if (d._ruler === c) break;
                        d = d.nextSibling
                    }
                    c ? d.rulerChanged = !0 : this._lineHeight && this._resetLineHeight(g, a);
                    if (!c || c.getOverview() === "page") for (d = d.firstChild; d;) {
                        var b = d.lineIndex;
        ...
        _handleBlur: function() {
            if (!this._ignoreBlur) {
                ...
                if (this._selDiv1) if (this._selDiv1.style.background = "lightgray", this._selDiv2.style.background = "lightgray", this._selDiv3.style.background = "lightgray", g = this._getWindow(), a = this._selDiv1.ownerDocument, g.getSelection) {
                    a = g.getSelection();
        ...
        _handleKeyPress: function(g) {
            if (!this._ignoreEvent(g)) if (this._keyDownPrevented) g.preventDefault && (g.preventDefault(), g.stopPropagation()),
        ...
        _handleMouseDown: function(g) {
            if (!this._ignoreEvent(g)) {
                if (this._linksVisible) if ((g.target || g.srcElement).tagName !== "A") this._setLinksVisible(!1);
                else return;
                this._commitIME();
                var a = g.which;
        ...
        _getModelOffset: function(g, a) {
            if (g) {
                ...
                var d = 0,
                b = c.lineIndex;
                if (g.tagName !== "DIV") for (c = c.firstChild; c;) {
                    var i = c.firstChild;
                    if (i === g) {
                        c.ignoreChars && (d -= c.ignoreChars);
                        d += a;
        ...
        _handleSelectionChange: function() {
            if (this._imeOffset === -1) if (d.isAndroid) {
        ...
        _doAction: function(g) {
            ...
            for (c = d.length - 1; c >= 0; c--) if (a = d[c], typeof a.match === "function" && (a = a.match(g), a !== void 0)) return this.invokeAction(a);
            return ! 1
        },
        _doMove: function(g, a) {
            ...
            for (; g.count !== 0;) {
                ...
                if (g.count < 0 && d === i) if (b > 0) g.unit === "character" && g.count++,
                b--,
                a.extend(c.getLineEnd(b));
                else break;
                else if (g.count > 0 && d === c.getLineEnd(b)) if (b + 1 < c.getLineCount()) g.unit === "character" && g.count--,
                b++,
        ...
        _doCursorNext: function(a) {
            var c = this._getSelection(); ! c.isEmpty() && !a.select ? c.start = c.end: this._doMove(a, c);
            a.select || c.collapse();
        ...
        _doLineDown: function(a) {
            ...
            n = m.getBoundingClientRect(n).left; (i = m.getLineIndex(i)) < m.getLineCount() - 1 ? j = m.getClientRects(i + 1).top + 1 : (i = c.getLineCount() - 1, e = f === i, a.count && a.count > 0 ? f = Math.min(f + a.count, i) : f++);
            i = !1;
            if (e) {
        ...
        _doLineUp: function(a) {
            ...
            n = m.getBoundingClientRect(n).left; (i = m.getLineIndex(i)) > 0 ? e = m.getClientRects(i - 1).top + 1 : (j = f === 0, j || (a.count && a.count > 0 ? f = Math.max(f - a.count, 0) : f--, e = this._getLineHeight(f) - 1));
            i = !1;
            if (j) {
        ...
        _calculateLineHeightTimer: function(a) {
            if (this._lineHeight && !this._calculateLHTimer) {
                ...
                if (a) {
                    for (var a = 0,
                    d = (new Date).getTime(), i = 0; b < c;) if (this._lineHeight[b] || (a++, i || (i = b), this._lineHeight[b] = this._calculateLineHeight(b)), b++, (new Date).getTime() - d > 100) break;
        ...
        _createView: function() {
            if (!this._clientDiv) {
                ...
                if (d.isIOS || d.isAndroid) a.style.WebkitTapHighlightColor = "transparent"; (this._clipDiv || b).appendChild(a);
        ...
        _getLinePixel: function(a) {
            ...
            if (this._lineHeight) {
                ...
                if (a > c) for (; c < a; c++) b += this._getLineHeight(c);
                else for (c -= 1; c >= a; c--) b -= this._getLineHeight(c);
                return b
            }
        ...
        _getLineIndex: function(a) {
            ...
            if (this._lineHeight) {
                ...
                if (a !== i) if (a < i) for (; a < i && b > 0;) a += this._getLineHeight(--b);
                else for (c = this._getLineHeight(b); a - c >= i && b < d - 1;) a -= c,
                c = this._getLineHeight(++b)
            } else c = this._getLineHeight(),
            b = Math.floor(a / c);
            return Math.max(0, Math.min(d - 1, b))
        },
        _getScroll: function(a) { (a === void 0 || a) && this._cancelAnimation();
            a = this._viewDiv;
            return {
                x: a.scrollLeft,
                y: a.scrollTop
        ...
        _modifyContent: function(a, c) {
            if (!this._readonly || a._code) if (a.type = "Verify", this.onVerify(a), !(a.text === null || a.text === void 0)) {
                var b = this._model;
                try {
        ...
        _resetLineHeight: function(a, c) {
            if (this._wrapMode || this._variableLineHeight) {
                if (a !== void 0 && c !== void 0) for (var b = a; b < c; b++) this._lineHeight[b] = void 0;
        ...
        _resetLineWidth: function() {
            var a = this._clientDiv;
            if (a) for (a = a.firstChild; a;) a.lineWidth = void 0,
            a = a.nextSibling
        },
        _reset: function() {
            this._maxLineIndex = -1;
        ...
        _setLinksVisible: function(a) {
            if (this._linksVisible !== a) {
                ...
                for (a = this._getLineNext(); a;) {
                    if (a.hasLink) for (c = a.firstChild; c;) if (c.ignore) c = c.nextSibling;
                    else {
                        var b = c.nextSibling,
                        i = c.viewStyle;
        ...
        _setTheme: function(a) {
            this._theme && this._theme.removeEventListener("ThemeChanged", this._themeListener.onChanged); (this._theme = a) && this._theme.addEventListener("ThemeChanged", this._themeListener.onChanged);
            ...
            if (! (this._redrawCount > 0)) {
                ...
                if (c) {
                    ...
                    if (a) {
                        ...
                        for (v = h; v <= i; v++) if (!w || w.lineIndex > v)(new r(this, v)).create(A, null);
                        else {
                        ...
                        for (A = !1; w;) {
                            h = w.lineWidth;
                            if (h === void 0) if (y = w._line.getBoundingClientRect(), h = w.lineWidth = Math.ceil(y.right - y.left), y = y.bottom - y.top, this._lineHeight) this._lineHeight[w.lineIndex] = y;
        ...
        _updateRuler: function(a, c, b, i) {
            if (a) for (var f = this._parent.ownerDocument,
            m = this._getLineHeight(), j = this._getViewPadding(), a = a.firstChild; a;) {
                ...
                if (a.rulerChanged && q) {
                    e = -1;
                    if (l = n.getWidestAnnotation()) if (k(l.style, q), l.html) q.innerHTML = l.html;
                    q.lineIndex = e;
                ...
                if (h === "page") {
                    ...
                    for (e = c; e <= b; e++) if (!r || r.lineIndex > e) {
                    ...
                    if (a.rulerChanged) {
                        ...
                        a.appendChild(o)
                    } else if (a._oldTrackHeight !== r) for (q = a.firstChild ? a.firstChild.nextSibling: null; q;) q.style.top = this._metrics.scrollWidth + m + Math.floor(q.lineIndex * h) + "px",
                    q = q.nextSibling;
                    a._oldTrackHeight = r
                }
                a.rulerChanged = !1;
    ...
    e.EventTarget.addMixin(t.prototype);
    return {
        TextView: t
    }
});
    ...
    o.prototype = {
        ...
        getLine: function(e, b) {
            ...
            for (c = 0; c < h.length; c++) {
                ...
                if (m._lineIndex + i >= e - k) if (a = e - (m._lineIndex + k), a < i) return m._model.getLine(a, b);
        ...
        getText: function(e, b) {
            ...
            for (a = 0; a < h.length; a++) {
                ...
                if (c.start + i > e - k) if (b !== void 0 && c.start + i > b - k) return c._model.getText(e - (c.start + k), b - (c.start + k));
        ...
        setText: function(e, b, d) {
            ...
            for (m = 0; m < a.length; m++) {
                ...
                if (n.start + j > b - c) if (d !== void 0 && n.start + j > d - c) {
...
function(l, p) {
    ...
    d.prototype = {
        ...
        getAnnotationTypePriority: function(a) {
            if (this._annotationTypes) for (var c = 0; c < this._annotationTypes.length; c++) if (this._annotationTypes[c] === a) return c + 1;
            return 0
        },
        ...
        removeAnnotationType: function(a) {
            if (this._annotationTypes) for (var c = 0; c < this._annotationTypes.length; c++) if (this._annotationTypes[c] === a) {
    ...
    h.prototype = {
        ...
        replaceAnnotations: function(a, c) {
            var b = this._annotations,
            d, f, j, e = [];
            if (a) for (d = a.length - 1; d >= 0; d--) j = a[d],
        ...
        setTextModel: function(a) {
            this._model && this._model.removeEventListener("Changed", this._listener.onChanged); (this._model = a) && this._model.addEventListener("Changed", this._listener.onChanged)
        },
    ...
    k.prototype = {
        destroy: function() {
            ...
            this.view = null; (a = this._annotationModel) && a.removeEventListener("Changed", this._listener.onChanged)
        },
        ...
        _onAnnotationModelChanged: function(a) {
            function c(a) {
                for (var c = 0; c < a.length; c++) if (d.isAnnotationTypeVisible(a[c].type)) {
                    var e = a[c].start,
                    h = a[c].end;
        ...
        _onLineStyle: function(a) {
            ...
            for (c = c.getAnnotations(f, j); c.hasNext();) if (f = c.next(), this.isAnnotationTypeVisible(f.type)) {
                if (f.rangeStyle) {
                    var j = f.start,
                    e = f.end;
...
function(l, p, o, e, b) {
    ...
    d.prototype = {
        ...
        _getAnnotationContents: function(b) {
            ...
            if (b.length === 1) if (f = b[0], f.title !== void 0) return d(f);
            else {
        ...
        _getNodeStyle: function(b, d, f) {
            var a;
            if (b && (a = b.style[d], !a)) if (b.currentStyle) {
                for (a = 0; (a = d.indexOf("-", a)) !== -1;) d = d.substring(0, a) + d.substring(a + 1, a + 2).toUpperCase() + d.substring(a + 2);
                a = b.currentStyle[d]
...
function(l, p, o, e) {
    ...
    b.prototype = {
        getAnnotations: function(a, c) {
            ...
            for (var h = [], b = this.getAnnotationsByType(b, f, j), f = 0; f < b.length; f++) for (var j = b[f], k = e.getLineAtOffset(j.start), l = e.getLineAtOffset(Math.max(j.start, j.end - 1)), g = k; g <= l; g++) {
                var o = g;
                if (d !== e) {
                    o = e.getLineStart(g);
                    o = d.mapOffset(o, !0);
            ...
            if (!this._multiAnnotation && this._multiAnnotationOverlay) for (var s in h) h[s]._multiple && (h[s].html += this._multiAnnotationOverlay.html);
            return h
        },
        ...
        setAnnotationModel: function(a) {
            this._annotationModel && this._annotationModel.removEventListener("Changed", this._listener.onAnnotationModelChanged); (this._annotationModel = a) && this._annotationModel.addEventListener("Changed", this._listener.onAnnotationModelChanged)
        },
        ...
        _onAnnotationModelChanged: function(a) {
            function c(a) {
                for (var c = 0; c < a.length; c++) if (f.isAnnotationTypeVisible(a[c].type)) {
                    var j = a[c].start,
                    e = a[c].end;
    ...
    f.prototype._onAnnotationModelChanged = function(a) {
        function c(a) {
            for (j = 0; j < a.length; j++) if (f.isAnnotationTypeVisible(a[j].type)) {
                var c = a[j].start;
...
function() {
    ...
    l.prototype = {
        ...
        _doUndoRedo: function(e, b, d, h, k) {
            ...
            if (f.mapOffset && h.annotationModel) {
                ...
                if (a < 0) for (var c = h.annotationModel.getAnnotations(e, e + 1); c.hasNext();) {
                    var i = c.next();
    ...
    p.prototype = {
        add: function(e) {
            ...
            this.endCaret = e.getCaretOffset(); (e = this.owner) && e.end && e.end()
        },
        undo: function(e, b) {
        ...
        start: function(e) {
            ...
            this.startCaret = e.getCaretOffset(); (e = this.owner) && e.start && e.start()
        }
    };
    o.prototype = {
        add: function(e) {
        ...
        _onChanging: function(e) {
            ...
            if (!this._ignoreUndo) {
                ...
                if (!this.compoundChange) if (e === 1 && h === 0) {
    ...
    l.prototype = {
        ...
        _onDragEnd: function(l) {
            ...
            if (this._dragSelection) {
                this._undoStack && this._undoStack.startCompoundChange(); (l = l.event.dataTransfer.dropEffect === "move") && o.setText("", this._dragSelection.start, this._dragSelection.end);
                if (this._dropText) {
                    var e = this._dropText,
                    b = this._dropOffset;
                    if (l) if (b >= this._dragSelection.end) b -= this._dragSelection.end - this._dragSelection.start;
...
function(l, p, o, e, b, d) {
    ...
    h.prototype = {
        ...
        _expandOffset: function(d) {
            ...
            if (c && a.getBaseModel) for (d = c.getAnnotations(d, d + 1); d.hasNext();) a = d.next(),
        ...
        installTextView: function() {
            ...
            if (this._annotationFactory) {
                ...
                if (this._annotationModel = this._annotationFactory.createAnnotationModel(m)) if (m = this._annotationStyler = this._annotationFactory.createAnnotationStyler(a, this._annotationModel)) m.addAnnotationType(b.AnnotationType.ANNOTATION_CURRENT_SEARCH),
        ...
        showProblems: function(d) {
            ...
            if (a) {
                ...
                if (d) for (n = 0; n < d.length; n++) if (j = d[n]) {
...
function(l, p, o, e, b, d, h) {
    ...
    f.prototype = {
        ...
        setOptions: function(a) {
            if (a) {
                if ((a.showAll === !0 || a.showAll === !1) && this._showAll !== a.showAll) if (this._showAll = a.showAll, this.isVisible()) if (this._showAll) this._markAllOccurrences();
                else {
...
function(l, p, o, e, b, d) {
    ...
    h.prototype = {
        init: function() {
            ...
            function() {
                if (this._find) {
                    var a = this.editor.getSelection(); (a = prompt(l.find, this.editor.getText(a.start, a.end))) && this._find.find(!0, {
                        findString: a
                    })
                }
            }.bind(this), {
        ...
        unindentLines: function() {
            ...
            if (b.getOptions("tabMode")) {
                for (var d = a.getModel(), f = a.getSelection(), e = d.getLineAtOffset(f.start), j = d.getLineAtOffset(f.end > f.start ? f.end - 1 : f.end), h = b.getOptions("tabSize"), k = Array(h + 1).join(" "), l = [], o = b = 0, g = e; g <= j; g++) {
                    var p = d.getLine(g, !0);
                    if (d.getLineStart(g) !== d.getLineEnd(g)) if (p.indexOf("\t") === 0) p = p.substring(1),
                    b++;
    ...
    k.prototype = {
        ...
        _findEnclosingComment: function(a, b, d) {
            ...
            o,
            g;
            for (j = f; j >= 0; j--) if (h = a.getLine(j), k = j === f ? b - a.getLineStart(f) : h.length, l = h.lastIndexOf("/*", k), h = h.lastIndexOf("*/", k), h > l) break;
            else if (l !== -1) {
                o = a.getLineStart(j) + l;
                break
            }
            for (j = e; j < a.getLineCount(); j++) if (h = a.getLine(j), k = j === e ? d - a.getLineStart(e) : 0, l = h.indexOf("/*", k), h = h.indexOf("*/", k), l !== -1 && l < h) break;
            else if (h !== -1) {
        ...
        removeBlockComment: function() {
            ...
            j,
            h;
            for (h = 0; h < f.length; h++) if (f.substring(h, h + 2) === "/*") {
                e = d.start + h;
                break
            }
            for (; h < f.length; h++) if (f.substring(h, h + 2) === "*/") {
                j = d.start + h;
                break
            }
        ...
        toggleLineComment: function() {
            var a = this.editor;
            if (a.getTextView().getOptions("readonly")) return ! 1;
            for (var b = a.getModel(), d = a.getSelection(), f = b.getLineAtOffset(d.start), e = b.getLineAtOffset(d.end > d.start ? d.end - 1 : d.end), j = !0, h = [], k, l, o = f; o <= e; o++) if (k = b.getLine(o, !0), h.push(k), !j || (l = k.indexOf("//")) === -1) j = !1;
            else if (l !== 0) {
                var g;
                for (g = 0; g < l; g++) if (j = k.charCodeAt(g), !(j === 32 || j === 9)) break;
                j = g === l
            }
            o = b.getLineStart(f);
            g = b.getLineEnd(e, !0);
...
function() {
    ...
    l.prototype = {
        ...
        _parse: function() {
            ...
            function(k, f, a) {
                ...
                m = null,
                n = i.indexOf(":");
                n !== -1 && (i = i.substring(0, n), f = "${" + i + "}", m = JSON.parse(c.substring(n + 1).replace("\\}", "}").trim())); (c = b[f]) || (c = b[f] = {});
                c.substitution = i;
                if (m) c.data = m; (d = l.substring(h, a)) && e.push(d);
                e.push(f);
                h = a + k.length;
                return i
    ...
    p.prototype = {
        ...
        getKeywordProposals: function(l) {
            var e = [],
            b = this.getKeywords();
            if (b) for (var d = 0; d < b.length; d++) b[d].indexOf(l) === 0 && e.push({
        ...
        this.linkedModeListener = {
            ...
            onModelChanged: function(a) {
                if (!this.ignoreVerify) {
                    ...
                    c, d; b;) if (c = this._getPositionChanged(b, a.start, a.start + a.removedCharCount), d = c.position, d === void 0 || d.model !== b) this.exitLinkedMode(!1),
            ...
            onVerify: function(a) {
                if (!this.ignoreVerify) {
                    for (var b = this.linkedModeModel,
                    c, d; b;) if (c = this._getPositionChanged(b, a.start, a.end), d = c.position, d === void 0 || d.model !== b) this.exitLinkedMode(!1),
                    b = this.linkedModeModel;
                    else break;
                    if (b) {
                        ...
                        l = 0; l < c.length; ++l) if (g = c[l], h = g.position, g.oldOffset = h.offset, g.model === b && g.group === d.group ? (h.offset += f, h.length += e, f += e) : (h.offset += f, g.ansestor && (h.length += d.count * e)), g.escape) g.model.escapePosition = h.offset;
                        this.ignoreVerify = !0;
    ...
    d.mixin(h.prototype, {
        ...
        selectLinkedGroup: function(d) {
            ...
            if (a) {
                ...
                if (a = this.contentAssist) if (a.offset = void 0, d.data && d.data.type === "link" && d.data.values)(this._groupContentAssistProvider = new b.TemplateContentAssist(d.data.values)).getPrefix = function() {
        ...
        _getModelPositions: function(b, a, c) {
            for (var d = a.groups,
            e = 0; e < d.length; e++) for (var h = d[e].positions, j = 0; j < h.length; j++) {
                var k = h[j];
                c && (k = {
                    offset: k.offset + c,
                    length: k.length
        ...
        _updateAnnotations: function(b) {
            ...
            if (a) {
                ...
                if (h = this.linkedModeModel) for (var b = b || this._getSortedPositions(h), j = 0; j < b.length; j++) if (k = b[j], k.model === h) {
...
function() {
    return {
        JSKeywords: "int,double,float,break,case,class,catch,continue,const,debugger,default,delete,do,else,enum,export,extends,false,finally,for,function,if,implements,import,in,instanceof,interface,let,new,null,package,private,protected,public,return,static,super,switch,this,throw,true,try,typeof,undefined,var,void,while,with,yield".split(","),
...
function(l) {
    ...
    p.prototype.getPrefix = function(a, b) {
        for (var d = b; d && /[A-Za-z<]/.test(a.charAt(d - 1));) if (d--, a.charAt(d) === "<") break;
...
function(l, p) {
    ...
    e.prototype = {
        ...
        onModelChanged: function(b) {
            var d = this.startLine; (b.addedLineCount || b.removedLineCount) && Array.prototype.splice.apply(this.lineStyles, [d, b.removedLineCount].concat(this._getEmptyStyle(b.addedLineCount)))
        },
        onStyleReady: function(b) {
        ...
        onLineStyle: function(b) {
            ...
            if (f) if (f.ranges) b.ranges = d(f.ranges, b.lineStart);
        ...
        setContentType: function(b) {
            this.contentType = b;
            if (this.services) for (b = 0; b < this.services.length; b++) {
...
function(l, p, o) {
    ...
    h.prototype = {
        ...
        _onModelChanged: function(b) {
            this._dbgEvent(b);
            var a = this.startLine; (b.removedLineCount || b.addedLineCount) && Array.prototype.splice.apply(this.lines, [a + 1, b.removedLineCount].concat(this._newLines(b.addedLineCount)));
        ...
        _getResumeLineIndex: function(b) {
            ...
            c = b - 1; c >= 0; c--) if (a[c].eolState || b - c > 40) return c;
            return - 1
        },
        getState: function(b) {
            var a = this.mode,
            c = this.lines,
            d, e;
            for (d = b - 1; d >= 0; d--) if (e = c[d], e.eolState || b - d > 40) break;
        ...
        onLineStyle: function(b) {
            ...
            if (d) {
                ...
                if (h && (b.ranges = h[0], b = this.annotationModel)) {
                    c = [];
                    d = [];
                    if (h = h[1]) for (var j = 0; j < h.length; j++) {
                        var k = h[j];
...
function(l) {
    function p(b) {
        ...
        b) if (Object.prototype.hasOwnProperty.call(b, e)) {
            var k = b[e];
    ...
    var e = {
        ...
        toRegExp: function(b) {
            ...
            function(a) {
                ...
                f = 0; f < e;) {
                    var h = a.charAt(f);
                    if (!d && h === "#") for (; f < e && h !== "\r" && h !== "\n";) h = a.charAt(++f);
                    else if (!d && /\s/.test(h)) for (; f < e && /\s/.test(h);) h = a.charAt(++f);
            ...
            for (k = 0; k < this.unsupported.length; k++) {
                var f; (f = this.unsupported[k].regex.exec(b)) && d(this.unsupported[k].func(f), f)
            }
            return RegExp(b, h)
        },
            ...
            p = 0; p < k; p++) {
                ...
                case "}":
                    ...
                    if (s === ")" && (u.type === 2 || u.type === 4)) {
                        ...
                        for (s = 0; s < c.length; s++) if (t = c[s], (t.type === 2 || t.type === 4) && t.start >= u.start && t.end <= g) if (t.start += 1, t.end += 1, t.num += 1, t.type === 2) j[t.oldNum] = t.num;
                        c.push(v);
                        m++;
                        break
                    }
        ...
        complexCaptures: function(b) {
            if (!b) return ! 1;
            for (var d in b) if (b.hasOwnProperty(d) && d !== "0") return ! 0;
            return ! 1
        }
    };
    o.prototype = {
        ...
        preprocess: function(b) {
            for (b = [b]; b.length !== 0;) {
                var d = b.pop();
                if (!d._resolvedRule || !d._typedRule) if (d._resolvedRule = this._resolve(d), d._typedRule = this._createTypedRule(d), this.addStyles(d.name), this.addStyles(d.contentName), this.addStylesForCaptures(d.captures), this.addStylesForCaptures(d.beginCaptures), this.addStylesForCaptures(d.endCaptures), d._resolvedRule !== d && b.push(d._resolvedRule), d.patterns) for (var e = 0; e < d.patterns.length; e++) b.push(d.patterns[e])
            }
        },
        ...
        _resolve: function(b) {
            ...
            if (b.include) {
                ...
                else if (d = this._allGrammars[b], !d) for (var e = 0; e < this.externalGrammars.length; e++) {
        ...
        push: function(b, d) {
            if (d) for (var e = d.length; e > 0;) b.push(d[--e])
        },
        exec: function(b, d, e) { (d = b.exec(d)) && (d.index += e);
            b.lastIndex = 0;
            return d
        },
        ...
        getNextMatch: function(b, d, e, k) {
            ...
            c = Number.MAX_VALUE;
            i = -1;
            for (l = 0; l < b.length; l++) if (n = b[l], n.index < c) c = n.index,
            i = l;
            if (!k && (e = this.getEndMatch(d, a, e))) if (k = d.rule.applyEndPatternLast, i === -1 || e.index < c || !k && e.index === c) return {
                isEnd: !0,
                rule: d.rule,
                match: e
            };
        ...
        getInitialExpected: function(b, d) {
            var e, k;
            if (b === this._tree) for (e = 0; e < b.children.length; e++) {
                if (k = b.children[e], k.start >= d) return k
            } else if (b instanceof this.BeginEndNode && b.endMatch) {
                var f = b.endMatch.index;
                for (e = 0; e < b.children.length; e++) if (k = b.children[e], k.start >= d) break;
        ...
        getInheritedLineScope: function(b) {
            for (var d = [], e = 0; e < b.length; e++) for (var k = b[e], f = k.node; f;) {
                var a = f.rule.rule,
                c = a.name;
        ...
        addMatchScope: function(b, d, e) {
            var k = e.rule,
            f = k.name; (k = k.captures) ? this.addCapturesScope(b, d, k, e.isComplex, e.matchOld2New, e.matchConsuming) : this.addScope(b, d, f)
        },
        ...
        getIntersecting: function(b, d) {
            for (var e = [], k = this._tree ? [this._tree] : []; k.length;) {
                ...
                if (a) for (var a = f.children.length,
...
function(l, p) {
    ...
    o.prototype = {
            ...
            default:
                ...
                if (97 <= a && a <= 122 || 65 <= a && a <= 90 || a === 95 || 45 === a && b) {
                    ...
                    if (a.length > 0) {
                        ...
                        for (b = 0; b < a.length; b++) if (this.keywords[b] === c) return 2
                    }
                }
                return 1
            }
        ...
        nextToken: function() {
            for (this.startOffset = this.offset;;) {
                ...
                case 47:
                    a = this._read();
                    if (!this.isCSS && a === 47) for (;;) if (a = this._read(), a === -1 || a === 10 || a === 13) return this._unread(a),
                    6;
                    if (a === 42) {
                        a = this._read();
                        b = 7;
                        for (a === 42 && (b = 8);;) {
                            for (; a === 42;) if (a = this._read(), a === 47) return b;
    ...
    b.prototype.nextToken = function() {
        for (this.startOffset = this.offset;;) {
            ...
            case 64:
                ...
                return 1;
            case 84:
                if ((a = this._read()) === 79) if ((a = this._read()) === 68) if ((a = this._read()) === 79) if (a = this._read(), !(97 <= a && a <= 122 || 65 <= a && a <= 90 || a === 95 || 48 <= a && a <= 57)) return this._unread(a),
                14;
                this._unread(a);
            default:
                do a = this._read();
    ...
    h.prototype = {
        ...
        _binarySearch: function(a, b, c, d, e) {
            ...
            for (; e - d > 1;) if (f = Math.floor((e + d) / 2), b <= a[f].start) e = f;
            else if (c && b < a[f].end) {
                e = f;
                break
            } else d = f;
                ...
                if (a.getBaseModel) {
                    ...
                    if (b) {
                        ...
                        for (var c = [], d = a.getBaseModel(), e = this.comments, f = 0; f < e.length; f++) {
                            var g = e[f]; (g = this._createFoldingAnnotation(a, d, g.start, g.end)) && c.push(g)
                        }
        ...
        _getStyles: function(a, b, c) {
            ...
            e = [], f = c, g = this.comments, h = this._binarySearch(g, c, !0); h < g.length; h++) {
                ...
                f = Math.max(f, j);
                j = Math.min(d, k); (l === 8 || l === 7) && (this.whitespacesVisible || this.detectHyperlinks) ? this._parseComment(b.substring(f - c, j - c), f, e, n, l) : l === 5 && this.whitespacesVisible ? this._parseString(b.substring(f - c, j - c), f, e, r) : e.push({
                    start: f,
                    end: j,
                    style: n
                });
            ...
            if (a.getBaseModel) for (b = 0; b < e.length; b++) c = e[b].end - e[b].start,
        ...
        _findMatchingBracket: function(a, b) {
            ...
            for (var g = a.getLineAtOffset(b), c = a.getLine(g), h = a.getLineStart(g), i = a.getLineEnd(g), c = this._findBrackets(d, f, c, h, h, i), i = 0; i < c.length; i++) if (h = c[i] >= 0 ? 1 : -1, c[i] * h - 1 === b) {
                var j = 1;
                if (e & 1) {
                    for (i--; i >= 0; i--) if (h = c[i] >= 0 ? 1 : -1, j += h, j === 0) return c[i] * h - 1;
                    for (g -= 1; g >= 0;) {
                        c = a.getLine(g);
                        h = a.getLineStart(g);
                        i = a.getLineEnd(g);
                        c = this._findBrackets(d, f, c, h, h, i);
                        for (e = c.length - 1; e >= 0; e--) if (h = c[e] >= 0 ? 1 : -1, j += h, j === 0) return c[e] * h - 1;
                        g--
                    }
                } else {
                    for (i++; i < c.length; i++) if (h = c[i] >= 0 ? 1 : -1, j += h, j === 0) return c[i] * h - 1;
                    g += 1;
                    for (e = a.getLineCount(); g < e;) {
                        ...
                        i = a.getLineEnd(g);
                        c = this._findBrackets(d, f, c, h, h, i);
                        for (i = 0; i < c.length; i++) if (h = c[i] >= 0 ? 1 : -1, j += h, j === 0) return c[i] * h - 1;
                        g++
                    }
                }
                break
        ...
        _findBrackets: function(a, b, c, d, e, f) {
            for (var g = [], a = a.charCodeAt(0), b = b.charCodeAt(0), h = e, i = this._scanner, j, k = this.comments, l = this._binarySearch(k, e, !0); l < k.length; l++) {
                ...
                j = k[l].start;
                var m = k[l].end;
                if (h < j) for (i.setText(c.substring(h - e, j - e)); j = i.nextToken();) j === a ? g.push(i.getStartOffset() + h - e + d + 1) : j === b && g.push( - (i.getStartOffset() + h - e + d + 1));
                h = m
            }
            if (h < f) for (i.setText(c.substring(h - e, f - e)); j = i.nextToken();) j === a ? g.push(i.getStartOffset() + h - e + d + 1) : j === b && g.push( - (i.getStartOffset() + h - e + d + 1));
            return g
        },
        _onDestroy: function() {
            this.destroy()
        ...
        _onModelChanged: function(a) {
            ...
            if (this.foldingEnabled && f !== a && this.annotationModel) {
                ...
                i = [];
                for (m = []; j.hasNext();) if (n = j.next(), n.type === l.AnnotationType.ANNOTATION_FOLDING) {
                    m.push(n);
                    for (h = 0; h < g.length; h++) if (n.start === g[h].start && n.end === g[h].end) break;
                ...
                for (h = 0; h < g.length; h++) {
                    n = g[h];
                    for (d = 0; d < m.length; d++) if (m[d].start === n.start && m[d].end === n.end) break;
...
function(l, p, o, e, b, d, h, k, f, a, c, i, m, n, j, q, r, t, v, g, u, x) {
    ...
    function I(a) {
        ...
        if (k) {
            ...
            function() { / css$ / .test(a.lang) ? k.setProviders([q]) : /js$/.test(a.lang) && k.setProviders([t])
            })
        }
    ...
    if (B) for (var F = 0; F < arguments.length; F++) H(B, arguments[F]);
    return I
});
