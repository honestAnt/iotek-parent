...
$(function(){
	$(".Teachers").Xslider({
		...
		numtoMove:1,
		speed:300,
		scrollobjSize:Math.ceil($(".Teachers").find("li").length/1)*216
	})
})
...
$(document).ready(function(){
	...
	/* 滑动/展开 */
	$(".expmenu li > .header").click(function(){
...
$(document).ready(function(){
	...
	$(".outlinemenu li > .outl_header").click(function(){
		...
		$(this).parent().find(".second_menu").slideToggle();
...
$(document).ready(function(){
	...
	/* 滑动/展开 */
	$(".outlinemenu li > .outl_header2").click(function(){
